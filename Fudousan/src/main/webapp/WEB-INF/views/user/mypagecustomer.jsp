	...
	<table>
		...
		<div id=customerMaemulCheck>
			<tr>
				...
				<th><input type="text" id ="roomSearch" name="roomSearch"></th><th><input type="button" onclick="roomSearch()" value="검색">
				<input type="hidden" id="memberId" name="memberId" value="${session의 아이디 }">
				</th><br>
